...
module.exports = {
    ...
    async execute(msg, args) {
        ...
        if (databaseUser.warn1) { A = databaseUser.warn1 } else { A = emotes.false }
        if (databaseUser.warn2) { B = databaseUser.warn2 } else { B = emotes.false }
        if (databaseUser.warn3) { C = databaseUser.warn3 } else { C = emotes.false }
